function pupilProcessRawMRIEyeTrackingDataLocalHookTemplate
% pupilProcessRawMRIEyeTrackingDataLocalHookTemplate
%
% For use with the ToolboxToolbox.  If you copy this into your
% ToolboxToolbox localToolboxHooks directory (by defalut,
% ~/localToolboxHooks) and delete "LocalHooksTemplate" from the filename,
% this will get run when you execute tbUse({'pupilProcessRawMRIEyeTrackingData'}) to set up for
...
%% Say hello
fprintf('Running pupilProcessRawMRIEyeTrackingData local hook\n');
...
addpath(genpath(['/Users/' userID '/Documents/MATLAB/Analysis/pupilProcessRawMRIEyeTrackingData']));
